...
class GoogleOAuth2Autenticator extends AbstractAuthenticator
{
    ...
    public function setClientId(string $value) : GoogleOAuth2Authenticator
    {
        $this->clientId = $value;
        return $this;
    }
    ...
    public function setClientSecret(string $value) : GoogleOAuth2Authenticator
    {
    ...
    public function setRedirectUri(string $value) : GoogleOAuth2Authenticator
    {
    ...
    public function setAccessType(string $value) : GoogleOAuth2Authenticator
    {
